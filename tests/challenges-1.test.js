...
const jsonData = './titanic-passengers.json';

function loadData(cb) {
  fs.readFile(jsonData, 'utf8', function (err, data) {
    try {
...
describe('Challenge 1 Titanic', () => {
  ...
  test('Challenge 3: Test getCasualtyCount', () => {
    expect(index.getCasualtyCount(data)).toBe(549);
  });
